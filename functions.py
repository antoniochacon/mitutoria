    ...
    for asignatura in asignaturas:
        ...
        for respuesta in respuestas:
            if respuesta:
                ...
                respuestas_asignatura_stacked.append(int(respuesta.resultado) / len(preguntas_by_tutoria_id(tutoria_id)))
